"""PlanarCellPolarity-model specific plot function for the state"""
...
def state_mean(dm: DataManager, *, hlpr: PlotHelper, uni: UniverseGroup, 
    ...
    Args:
        ...
        mean_of (str): The name of the PlanarCellPolarity dataset that the mean is to be
            calculated of
        **plot_kwargs: Passed on to matplotlib.pyplot.plot
    """
    # Extract the data
    data = uni['data/PlanarCellPolarity'][mean_of]
...
def some_DAG_based_PlanarCellPolarity_plot(*, data: dict, hlpr: PlotHelper,
